...
public class DialogColaborador extends javax.swing.JDialog {
    ...
    //filtros
    private void carregaColaborador() throws SQLException{
        List<Colaborador> lista = dao.getColaboradorList();
        TableColaborador.setModel( new MyTableModel(Padrao.class, lista, TableColaborador));
                
    }
    
    private void carregaColaborador(String filtro) throws SQLException{
        List<Colaborador> lista = dao.getColaboradorList(filtro);
        TableColaborador.setModel( new MyTableModel(Padrao.class, lista, TableColaborador));
    ...
    private void ButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonSalvarActionPerformed
        ...
        try{
           ...
           this.carregaColaborador();
            ...
            Logger.getLogger(DialogColaborador.class.getName()).log(Level.SEVERE, null, ex);
        }
