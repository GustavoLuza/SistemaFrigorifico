...
public class DialogFazenda extends javax.swing.JDialog {
    ...
    //filtros
    private void carregaFazenda() throws SQLException{
        List<Fazenda> lista = dao.getFazendaList();
        TableFazenda.setModel( new MyTableModel(Padrao.class, lista, TableFazenda));
                
    }
    
    private void carregaFazenda(String filtro) throws SQLException{
        List<Fazenda> lista = dao.getFazendaList(filtro);
        TableFazenda.setModel( new MyTableModel(Padrao.class, lista, TableFazenda));
    }
    ...
    private void populateComponente(Fazenda fazenda){
        ...
        TextContato.setText(fazenda.getContato());
