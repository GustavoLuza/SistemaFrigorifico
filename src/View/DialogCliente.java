...
public class DialogCliente extends javax.swing.JDialog {
    ...
    private void carregaCliente() throws SQLException{
        ...
        TableCliente.setModel( new MyTableModel(Padrao.class, lista, TableCliente));
    ...
    private Cliente populateObjeto(){
        return(new Cliente(TextID.getText().isEmpty() ? 0 : Integer.parseInt(TextID.getText()), TextNome.getText(), TextCNPJ.getText(),TextTelefone.getText(),TextEndereco.getText(),TextContato.getText()));
    }
