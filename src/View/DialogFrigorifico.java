...
public class DialogFrigorifico extends javax.swing.JDialog {
    ...
    //filtros
    private void carregaFrigorifico() throws SQLException{
        List<Frigorifico> lista = dao.getFrigorificoList();
        TableFrigorifico.setModel( new MyTableModel(Padrao.class, lista, TableFrigorifico));
                
    }
    
    private void carregaFrigorifico(String filtro) throws SQLException{
        List<Frigorifico> lista = dao.getFrigorificoList(filtro);
        TableFrigorifico.setModel( new MyTableModel(Padrao.class, lista, TableFrigorifico));
    ...
    private void TableFrigorificoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableFrigorificoMouseClicked
        ...
        try{
            if (evt.getClickCount()==2){
                ...
                populateComponente(dao.getFrigorifico(codigo));
            }
        }catch(SQLException ex){
            System.out.println("ERRO: "+ex.getMessage());
        }
