...
public class DialogVenda extends javax.swing.JDialog {
    ...
    SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
     ...
     private void carregaFKCliente() throws SQLException{
        DaoCliente daoCliente = new DaoCliente();
        DefaultComboBoxModel cbm = new DefaultComboBoxModel(new Vector(daoCliente.getClienteList()));
        ComboCliente.setModel(cbm);
    }
    
    private void carregaFKProduto() throws SQLException{
        DaoProduto daoProduto = new DaoProduto();
        DefaultComboBoxModel cbm = new DefaultComboBoxModel(new Vector(daoProduto.getProdutoList()));
    ...
    private void carregaVenda(String filtro) throws SQLException{
    ...
    private void ButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonPesquisarActionPerformed
        ...
        try{
            ...
            this.carregaVenda(TextPesquisar.getText());
           }catch(SQLException ex){
            System.out.println("ERRO: "+ex.getMessage());
        }
